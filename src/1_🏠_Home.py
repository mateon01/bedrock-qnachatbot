...
sidebar_title = '<p style="font-family:Amazon Ember; color:#FF9900; font-size: 30px; "><b>Amazon Bedrock Powered - 수출화물팀 SOP Q&A</b></p>'
...
db = OpenSearchVectorClient(host=host,
